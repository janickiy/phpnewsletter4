...
<div class="left hidden-xs">
  ...
  <div class="sidebar">
    ...
    <div class="accordion">
      <div class="accordion-group">
        <div class="accordion-heading"> <a class="sbtn btn-default<!-- IF '${ACTIVE_MENU}' == 'create_template' -->  active<!-- END IF -->" title="${MENU_CREATE_NEW_TEMPLATE_TITLE}" href="./?task=create_template"> <i class="fa fa-plus"></i>&nbsp;${MENU_CREATE_NEW_TEMPLATE} </a> </div>
      </div>
    </div>
    <div class="accordion">
      <div class="accordion-group">
        <div class="accordion-heading"> <a class="sbtn btn-default<!-- IF '${ACTIVE_MENU}' == 'subscribers' -->  active<!-- END IF -->" href="./?task=subscribers" title="${MENU_SUBSCRIBERS_TITLE}"> <i class="fa fa-users"></i>&nbsp;${MENU_SUBSCRIBERS} </a> </div>
      </div>
    </div>
    <div class="accordion">
      <div class="accordion-group">
        <div class="accordion-heading"> <a class="sbtn btn-default<!-- IF '${ACTIVE_MENU}' == 'category' -->  active<!-- END IF -->" href="./?task=category" title="${MENU_CATEGORY_TITLE}"> <i class="fa fa-list"></i>&nbsp;${MENU_CATEGORY} </a> </div>
      </div>
    </div>
    <div class="accordion">
      <div class="accordion-group">
        <div class="accordion-heading"> <a class="sbtn btn-default<!-- IF '${ACTIVE_MENU}' == 'log' -->  active<!-- END IF -->" href="./?task=log" title="${MENU_LOG_TITLE}"> <i class="fa fa-area-chart"></i>&nbsp;${MENU_LOG} </a> </div>
      </div>
      <div class="accordion">
        <div class="accordion-group">
          <div class="accordion-heading"> <a class="sbtn btn-default<!-- IF '${ACTIVE_MENU}' == 'settings' -->  active<!-- END IF -->" href="./?task=settings" title="${MENU_SETTINGS_TITLE}"> <i class="fa fa-gear"></i>&nbsp;${MENU_SETTINGS} </a> </div>
        </div>
      </div>
      <div class="accordion">
        <div class="accordion-group">
          <div class="accordion-heading"> <a class="sbtn btn-default<!-- IF '${ACTIVE_MENU}' == 'security' -->  active<!-- END IF -->" href="./?task=security" title="${MENU_SECURITY_TITLE}"> <i class="fa fa-key"></i>&nbsp;${MENU_SECURITY} </a> </div>
        </div>
      </div>
      <div class="accordion">
        <div class="accordion-group">
          <div class="accordion-heading"> <a class="sbtn btn-default<!-- IF '${ACTIVE_MENU}' == 'update' -->  active<!-- END IF -->" href="./?task=update" title="${MENU_UPDATE_TITLE}"> <i class="fa fa-refresh"></i>&nbsp;${MENU_UPDATE} </a> </div>
        </div>
      </div>
      <div class="accordion">
        <div class="accordion-group">
          <div class="accordion-heading"> <a class="sbtn btn-default<!-- IF '${ACTIVE_MENU}' == 'faq' -->  active
		<!-- END IF -->" href="./?task=faq" title="FAQ"><i class="fa fa-question-circle"></i>&nbsp;FAQ </a> </div>
        </div>
      </div>
    </div>
  </div>
...
<div class="nav">
  <div class="bar">
    <div class="hov">
      <p class="text-center"><a href="./?task=logout">${STR_LOGOUT}</a></p>
    </div>
  </div>
</div>
<div class="content">
