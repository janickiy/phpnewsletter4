...
if($_POST["action"]){
	...
	$_POST['number_pos'] = trim($_POST['number_pos']);
	$fields['number_pos'] = (int)$_POST['number_pos'];
	$_POST['number_pos_users'] = trim($_POST['number_pos_users']);
	$fields['number_pos_users'] = (int)$_POST['number_pos_users'];
...
$tpl->assign('SET_NUMBER_POS',$PNSL["lang"]["set"]["number_pos"]);
$tpl->assign('SET_NUMBER_POS_USERS',$PNSL["lang"]["set"]["number_pos_users"]);
