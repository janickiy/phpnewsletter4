...
<div class="span3" id="sidebar"> <span class="logo"></span> <span class="version">${SCRIPT_VERSION}</span>
  ...
  <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
    ...
    class="active"
    <!-- END IF -->
    ><a href="./?task=create_template" title="${MENU_CREATE_NEW_TEMPLATE_TITLE}"><i class="fa fa-plus"></i> ${MENU_CREATE_NEW_TEMPLATE}</a><span class="menu-create-tmpl-icon"></span>
    </li>
    <li
    <!-- IF '${ACTIVE_MENU}' == 'subscribers' -->
    class="active"
    <!-- END IF -->
    ><a href="./?task=subscribers" title="${MENU_SUBSCRIBERS_TITLE}"><i class="fa fa-users"></i> ${MENU_SUBSCRIBERS}</a>
    </li>
    <li
    <!-- IF '${ACTIVE_MENU}' == 'category' -->
    class="active"
    <!-- END IF -->
    ><a href="./?task=category" title="${MENU_CATEGORY_TITLE}"><i class="fa fa-list"></i> ${MENU_CATEGORY}</a>
    </li>
    <li
    <!-- IF '${ACTIVE_MENU}' == 'log' -->
    class="active"
    <!-- END IF -->
    ><a href="./?task=log" title="${MENU_LOG_TITLE}"><i class="fa fa-area-chart"></i> ${MENU_LOG}</a>
    </li>
    <li
    <!-- IF '${ACTIVE_MENU}' == 'settings' -->
    class="active"
    <!-- END IF -->
    ><a href="./?task=settings" title="${MENU_SETTINGS_TITLE}"><i class="fa fa-gear"></i> ${MENU_SETTINGS}</a>
    </li>
    <li
    <!-- IF '${ACTIVE_MENU}' == 'security' -->
    class="active"
    <!-- END IF -->
    ><a href="./?task=security" title="${MENU_SECURITY_TITLE}"><i class="fa fa-key"></i> ${MENU_SECURITY}</a>
    </li>
    <li
    <!-- IF '${ACTIVE_MENU}' == 'update' -->
    class="active"
    <!-- END IF -->
    ><a href="./?task=update" title="${MENU_UPDATE_TITLE}"><i class="fa fa-refresh"></i> ${MENU_UPDATE}</a>
    </li>
    <li
    <!-- IF '${ACTIVE_MENU}' == 'faq' -->
    class="active"
    <!-- END IF -->
    ><a href="./?task=faq" title="FAQ"><i class="fa fa-question-circle"></i> FAQ</a>
    </li>
  </ul>
</div>
<div class="span9" id="content">
<div class="row"><p class="text-right"><a href="./?task=logout">${STR_LOGOUT}</a></p></div>
<div class="row-fluid">
