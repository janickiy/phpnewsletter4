...
$tpl->assign('STR_THERE_ARE_NO_MORE_ENTRIES', $PNSL["lang"]["str"]["there_are_no_more_entries"]);
$tpl->assign('SHOW_MORE', $PNSL["lang"]["str"]["show_more"]);
$tpl->assign('STR_CLICK', $PNSL["lang"]["str"]["click"]);
$tpl->assign('STR_LOADING_DATA', $PNSL["lang"]["str"]["loading_data"]);
...
if($_GET['id_log']){
	...
	$arr = $data->getDetaillog($strtmp, $limit);
	...
	$blockDetailLog->assign('STR_MORE', $PNSL["lang"]["str"]["more"]);
