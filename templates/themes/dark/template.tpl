  ...
  <table class="table table-hover table-bordered">
    ...
    <tbody>
      ...
      <tr class="td-middle${CLASS_NOACTIVE}">
        ...
        <td><a title="${STR_EDIT_MAILINGTEXT}" href="./?task=edit_template&id_template=${ROW_ID_TEMPLATE}">${ROW_TMPLNAME}</a><br>
          <br>
          ${ROW_CONTENT}
          </div></td>
        ...
        <td class="center"><a href="./?task=edit_template&id_template=${ROW_ID_TEMPLATE}" class="btn btn-default btn" title="${STR_EDIT}"><i class="icon icon-edit"></i></a></td>
      </tr>
      <!-- END column -->
      <!-- END row -->
    </tbody>
